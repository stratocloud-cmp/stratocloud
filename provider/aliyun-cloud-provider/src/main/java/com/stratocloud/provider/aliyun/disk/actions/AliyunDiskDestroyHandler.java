...
@Component
public class AliyunDiskDestroyHandler implements DestroyResourceActionHandler {
    private final AliyunDiskHandler diskHandler;

    public AliyunDiskDestroyHandler(AliyunDiskHandler diskHandler) {
    ...
    public void run(Resource resource, Map<String, Object> parameters) {
        ...
        provider.buildClient(account).ecs().deleteDisk(resource.getExternalId());
    }
