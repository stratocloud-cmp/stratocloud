...
@Component
public class AliyunHttpListenerToServerGroupHandler implements ExclusiveRequirementHandler {

    private final AliyunHttpListenerHandler listenerHandler;

    private final AliyunClbServerGroupHandler serverGroupHandler;

    public AliyunHttpListenerToServerGroupHandler(AliyunHttpListenerHandler listenerHandler,
    ...
    public String getRelationshipTypeId() {
        return "ALIYUN_HTTP_LISTENER_TO_SERVER_GROUP_RELATIONSHIP";
    }
