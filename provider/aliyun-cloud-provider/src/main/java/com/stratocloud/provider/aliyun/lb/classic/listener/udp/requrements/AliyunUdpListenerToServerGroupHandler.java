...
@Component
public class AliyunUdpListenerToServerGroupHandler implements ExclusiveRequirementHandler {

    private final AliyunUdpListenerHandler listenerHandler;

    private final AliyunClbServerGroupHandler serverGroupHandler;

    public AliyunUdpListenerToServerGroupHandler(AliyunUdpListenerHandler listenerHandler,
    ...
    public String getRelationshipTypeId() {
        return "ALIYUN_UDP_LISTENER_TO_SERVER_GROUP_RELATIONSHIP";
    }
