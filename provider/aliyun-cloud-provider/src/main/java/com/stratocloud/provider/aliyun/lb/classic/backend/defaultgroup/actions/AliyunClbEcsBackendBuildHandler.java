...
@Component
public class AliyunClbEcsBackendBuildHandler implements BuildResourceActionHandler {

    private final AliyunClbEcsBackendHandler backendHandler;

    public AliyunClbEcsBackendBuildHandler(AliyunClbEcsBackendHandler backendHandler) {
    ...
    public void run(Resource resource, Map<String, Object> parameters) {
        ...
        Resource instance = resource.getEssentialTarget(ResourceCategories.COMPUTE_INSTANCE).orElseThrow(
                () -> new StratoException("Instance not found when creating backend.")
        );
