...
@Slf4j
@Component
public class AliyunHttpsListenerToAclHandler extends AliyunListenerToAclHandler {

    public AliyunHttpsListenerToAclHandler(AliyunHttpsListenerHandler listenerHandler,
    ...
    public String getRelationshipTypeId() {
        return "ALIYUN_CLB_HTTPS_LISTENER_TO_ACL_RELATIONSHIP";
    }
