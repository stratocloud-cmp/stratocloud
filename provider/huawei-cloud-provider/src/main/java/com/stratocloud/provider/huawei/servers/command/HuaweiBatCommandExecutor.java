...
public class HuaweiBatCommandExecutor extends HuaweiCommandExecutor{
    public HuaweiBatCommandExecutor(Resource guestOsResource, GuestOsHandler guestOsHandler) {
        super(guestOsResource, guestOsHandler);
    }

    @Override
    protected AddScriptModel.TypeEnum getHuaweiScriptType() {
        return AddScriptModel.TypeEnum.BAT;
    }
