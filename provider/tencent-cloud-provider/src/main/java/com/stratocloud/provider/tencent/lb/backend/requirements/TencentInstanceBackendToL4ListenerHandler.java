...
@Component
public class TencentInstanceBackendToL4ListenerHandler implements EssentialRequirementHandler {

    public static final String TYPE_ID = "TENCENT_INSTANCE_BACKEND_TO_L4_LISTENER_RELATIONSHIP";
    private final TencentInstanceBackendHandler backendHandler;

    private final TencentL4ListenerHandler listenerHandler;

    public TencentInstanceBackendToL4ListenerHandler(TencentInstanceBackendHandler backendHandler,
