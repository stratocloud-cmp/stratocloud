...
@Component
public class TencentCdbToZoneHandler implements EssentialRequirementHandler {

    private final TencentCdbHandler cdbHandler;

    private final TencentZoneHandler zoneHandler;

    public TencentCdbToZoneHandler(TencentCdbHandler cdbHandler, TencentZoneHandler zoneHandler) {
    ...
    public String getRelationshipTypeId() {
        return "TENCENT_CDB_TO_ZONE_RELATIONSHIP";
    }
    ...
    public List<ExternalRequirement> describeExternalRequirements(ExternalAccount account, ExternalResource source) {
        ...
        Optional<ExternalResource> zone = zoneHandler.describeExternalResource(account, instanceInfo.get().getZone());
