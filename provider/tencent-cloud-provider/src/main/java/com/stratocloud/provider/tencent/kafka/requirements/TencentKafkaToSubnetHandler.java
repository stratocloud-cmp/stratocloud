...
@Component
public class TencentKafkaToSubnetHandler implements EssentialRequirementHandler {

    private final TencentKafkaHandler kafkaHandler;

    private final TencentSubnetHandler subnetHandler;

    public TencentKafkaToSubnetHandler(TencentKafkaHandler kafkaHandler,
    ...
    public String getRelationshipTypeId() {
        return "TENCENT_KAFKA_TO_SUBNET_RELATIONSHIP";
    }

    @Override
    public String getRelationshipTypeName() {
        return "腾讯云Kafka实例与子网";
    }
    ...
    public List<ExternalRequirement> describeExternalRequirements(ExternalAccount account, ExternalResource source) {
        ...
        String subnetId = kafka.get().getSubnetId();
