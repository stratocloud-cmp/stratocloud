...
@Component
public class TencentL4ListenerToInternalLbHandler extends TencentListenerToLbHandler {

    public static final String TYPE_ID = "TENCENT_L4_LISTENER_TO_INTERNAL_LB_RELATIONSHIP";

    public TencentL4ListenerToInternalLbHandler(TencentInternalLoadBalancerHandler loadBalancerHandler,
