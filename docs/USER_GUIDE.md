...
* 编辑用户
  * 进入`系统管理/用户管理`菜单，点击列表项中的`编辑`按钮
* 关联角色
  * 进入`系统管理/用户管理`菜单，点击列表项中的`关联角色`按钮，在弹出角色列表的`关联状态`列可直接更改用户与角色的关联状态
* 修改密码
  * 进入`系统管理/用户管理`菜单，点击列表项中的`修改密码`按钮
* 启用
...
* 编辑角色
  * 进入`系统管理/角色管理`菜单，点击列表项中的`编辑`按钮
* 关联用户
  * 进入`系统管理/角色管理`菜单，点击列表项中的`关联用户`按钮，在弹出用户列表的`关联状态`列可直接更改角色与用户的关联状态
* 关联权限
  * 进入`系统管理/角色管理`菜单，点击列表项中的`关联权限`按钮，在弹出的权限菜单中可直接修改角色的权限
* 删除角色
...
* 更新
  * 进入`系统管理/用户组管理`菜单，点击列表项中的`更新`按钮
* 成员管理
  * 进入`系统管理/用户组管理`菜单，点击列表项中的`成员管理`按钮，您可以在弹出的成员列表中添加和移除用户组成员
* 删除
...
* 管理标签值
  * 进入`云管理/标签管理`菜单，点击列表项中的`管理标签值`按钮
  * 在弹出的标签值列表页面，您可以新增和删除标签值
* 更新
  * 进入`云管理/标签管理`菜单，点击列表项中的`更新`按钮
* 删除
...
* 查看资源详情
  ...
  * 在资源详情页中，您可以在`标签`一栏中直接绑定或解绑标签
  * 在资源详情页中，您可以在`描述`一栏中直接修改资源描述
## 3.8 资源关系
* 管理资源关系
